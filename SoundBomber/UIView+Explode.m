...
- (void)lp_explodeWithCompletion:(void (^)(BOOL))completion
{
...
{
//    [super animationDidStop:theAnimation finished:YES];
...
//            NSLog(@"Self.superview subviews: %@", self.superview.subviews);
